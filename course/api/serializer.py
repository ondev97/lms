...
class CourseDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Course
        fields = ['id','course_name','author','course_cover','course_description','subject','created_at','price','duration']
...
class MycoursesSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Enrollment
        fields = ['id','course','enroll_key','student']
        depth = 1
...
class SubjectViewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Subject
        fields = ['id','subject_name','subject_cover','subject_type','class_type','author','short_description','created_at']
